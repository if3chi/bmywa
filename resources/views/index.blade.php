            ...
            <div class="relative mt-12 space-y-5">
                ...
                <div x-data="{ show: false }"
                    ...
                    <h4 @click="show=!show"
                        ...
                        <svg class="w-6 h-6 transition-all duration-200 ease-out transform rotate-0"
                    ...
                    <p class="pt-0 -mt-2 text-gray-400 sm:text-lg py-7 px-7"
                        ...
                        x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" x-cloak="">Winners
                        will be
                        notified by phone, email and text with details provided on the entry forms</p>
                </div>
                ...
                <div x-data="{ show: false }"
                    ...
                    <p class="pt-0 -mt-2 text-gray-400 sm:text-lg py-7 px-7"
                        ...
                        x-transition:leave="transition-all ease-out hidden duration-200"
                        x-transition:leave-start="opacity-100 transform -translate-y-0"
                        x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" x-cloak="">Preferably
                        typed essays, however hand written essays MUST be readable to increase your chance to win.</p>
                </div>
                ...
                <div x-data="{ show: false }"
                    ...
                    <p class="pt-0 -mt-2 text-gray-400 sm:text-lg py-7 px-7"
                        ...
                        x-transition:leave="transition-all ease-out hidden duration-200"
                        x-transition:leave-start="opacity-100 transform -translate-y-0"
                        x-transition:leave-end="opacity-0 transform -translate-y-4" x-show="show" x-cloak="">We have 3
                        judges who are indigenous writers with expertise to review each essays. Essays are marked based
                        on
                        character, plot, originality, grammar, setting.</p>
                </div>
            </div>
