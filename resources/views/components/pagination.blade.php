<div>
    @if ($paginator->hasPages())
        <div
            class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-900 uppercase border-t dark:border-gray-700 bg-gray-200 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800 rounded-b-md">
