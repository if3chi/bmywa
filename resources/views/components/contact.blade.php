            ...
            <div class="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
                ...
                <div class="relative w-full mt-10 space-y-8">
                    <div class="relative">
                        ...
                        <input type="text"
                            class="block w-full p-3 mt-2 text-xl placeholder-gray-400 border-2 border-yellow-100 rounded-lg focus:outline-none focus:ring-4 focus:ring-yellow-600 focus:ring-opacity-50"
                    ...
                    <div class="relative">
                        ...
                        <textarea type="password"
                            class="block w-full p-5 mt-2 text-xl placeholder-gray-400 border-2 border-yellow-100 rounded-lg focus:outline-none focus:ring-4 focus:ring-yellow-600 focus:ring-opacity-50"
