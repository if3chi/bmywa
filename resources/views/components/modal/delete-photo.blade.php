...
<x-modal :id="$id" :maxWidth="$maxWidth" {{ $attributes }}>
    <div>
        <div class="sm:flex sm:items-start">
            ...
            <div class=" flex mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left space-x-3">
                <div class="flex-1">
                    ...
                    <div class="mt-2 text-center md:text-justify">
                        <p class="text-sm text-gray-500 mt-4">
                            ...
                            <span
                                class="text-md font-bold text-red-600 bg-red-100 dark:bg-red-500 rounded-md p-0.5">Photo(s)?</span>
                            </br> </br> <span class="mt-4">
                                This data will be permanently removed from our servers forever.
                            </span>
                            </br></br>  <span class="text-md font-bold text-red-600">This action cannot be undone.</span>
                        </p>
                    </div>
                </div>
                <div class="flex-1 p-2 place-self-center">
                    {{ $slot }}
                </div>
            </div>
        </div>
