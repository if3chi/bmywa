...
<div class="relative mb-6">
    ...
    <textarea {{ $attributes }} id="{{ $id }}" wire:dirty.class="border-yellow-100 focus:ring-yellow-300"
        ...
        class="block w-full h-36  p-2 mt-6 text-sm text-justify  placeholder-gray-400 tracking-wider font-light  bg-white border-2 rounded-md focus:ring focus:outline-none {{ $error ? 'border-red-100 focus:ring-red-400' : 'border-yellow-100 focus:ring-yellow-300' }}"
