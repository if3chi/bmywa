            ...
            <div class="error-h px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
                <div class="max-w-max mx-auto">
                    <main class="sm:flex">
                        ...
                        <div class="sm:ml-6">
                            <div class="sm:bottom-2 sm:border-l sm:border-gray-500 sm:pl-6">
                                <h1 class="text-4xl font-extrabold text-gray-700 tracking-tight sm:text-5xl">Not Found</h1>
                                <p class="mt-1 text-base text-gray-500">The link you followed may be broken, </br>or the page may have been removed.</p>
                            </div>
