    ...
    <div class="box-border px-4 mx-auto border-solid md:px-6 lg:px-8 max-w-7xl">
        <div
            ...
            <ul class="box-border flex mx-auto my-6 md:space-x-4 lg:space-x-6">
                ...
                <li class="relative mt-2 leading-7 text-left text-white border-0 border-gray-200 md:border-b-0 md:mt-0">
                    <a href="{{ route('welcome') . '#judges' }}"
                        class="box-border items-center block w-full px-2 md:pd-4 text-base font-normal leading-normal text-white no-underline border-solid cursor-pointer hover:text-yellow-600 focus-within:text-yellow-700 sm:px-0 sm:text-left">Judges</a>
                </li>
                <li class="relative mt-2 leading-7 text-left text-white border-0 border-gray-200 md:border-b-0 md:mt-0">
                    <a href="#_"
